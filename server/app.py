...
class MemberOnlyIndex(Resource):
    def get(self):
        ...
        # User is logged in, return JSON data for members-only articles
        member_articles = [article.to_dict() for article in Article.query.filter(Article.is_member_only == True)]
...
class MemberOnlyArticle(Resource):
    def get(self, id):
        ...
        # User is logged in, return JSON data for a specific members-only article
